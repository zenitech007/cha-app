  ...
  return (
    <>
      ...
      <button
        ...
        className="group inline-flex items-center gap-2.5 rounded-full border border-border bg-background px-5 py-2.5 text-sm font-medium transition-all hover:border-foreground/20 hover:shadow-sm"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          {/* Drawer panel */}
          <div
            className="relative flex w-full max-w-md flex-col bg-background shadow-2xl"
            style={{ animation: "slideIn 300ms cubic-bezier(0.16,1,0.3,1)" }}
          >
            {/* Close button */}
            <button
              onClick={close}
              className="absolute right-5 top-5 flex h-8 w-8 items-center justify-center rounded-full text-muted transition-colors hover:bg-surface hover:text-foreground"
            >
                  ...
                  >
                    ...
                    {link.donationUrl ? (
                      <a
                        ...
                        className="mt-5 flex h-12 items-center justify-center rounded-md bg-foreground text-sm font-medium text-background transition-opacity hover:opacity-80"
                      >
